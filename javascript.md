...
<h4 id="单行注释">2.4.1 单行注释</h4>


##### [强制] 必须独占一行。`//` 后跟一个空格，缩进与下一行被注释说明的代码一致。

<h4 id="多行注释">2.4.2 多行注释</h4>


##### [建议] 避免使用 `/*...*/` 这样的多行注释。有多行注释内容时，使用多个单行注释。


<h4 id="文档化注释">2.4.3 文档化注释</h4>
...
<h4 id="函数/方法注释">2.4.8 函数/方法注释</h4>
...
<h3 id="动态特性">3.10 动态特性</h3>

<h4 id="eval">3.10.1 eval</h4>
...
<h2 id="浏览器环境">4 浏览器环境</h2>

<h3 id="模块化">4.1 模块化</h3>

<h4 id="AMD">4.1.1 AMD</h4>
...
<h4 id="require">4.1.3 require</h4>
...
<h3 id="DOM">4.2 DOM </h3>

<h4 id="元素获取">4.2.1 元素获取</h4>
